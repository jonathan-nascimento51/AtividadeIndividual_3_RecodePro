...
<head>
	...
	<title>Sobre Nós | Air Lines Vibes</title>
    <!-- CSS only -->
...
<body>
    ...
    <figure class="container-fluid" style="margin: 0px; padding:0px;">
      <img class="w-100" src="img/quemsomos,edit.jpg" style="height: 500px;">
      <div class="text-center">
        <h2 class="text-dark pt-4" style="font-size: 50px;">Conheça a empresa Air Lines Vibes:</h2>
      </div>
    </figure>
    
    <main class="text-dark container pt-4">
      <h1 class="pb-2">Quem Somos:</h1>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, dignissimos! Suscipit rerum
         quisquam ipsam facere nihil. Corporis repellat, voluptate consequatur et nisi, totam doloremque iure,
         ipsum fugiat quae impedit temporibus? Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita
         nulla temporibus adipisci sapiente laboriosam minus soluta corporis 
         aliquid. Nihil quidem labore ullam neque fuga temporibus illum. Voluptate quidem perferendis itaque.
      </p>

      <h1 class="pb-2 pt-5">Nossa História:</h1>
      <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Esse fugit maiores aliquid
         ratione eligendi porro, eum quisquam beatae incidunt obcaecati odit nisi omnis laborum.
         At amet accusantium ab obcaecati inventore. Lorem, ipsum dolor sit amet consectetur
         adipisicing elit. Iste voluptatem pariatur odio corporis repellat soluta perferendis,
         dicta iusto doloremque eaque sint deleniti aperiam similique id vitae dolorem at magnam voluptate.
      </p>
    </main>
