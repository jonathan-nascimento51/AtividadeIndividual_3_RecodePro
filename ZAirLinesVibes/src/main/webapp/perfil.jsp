...
<head>
	<meta charset="utf-8">
	<title>Perfil | Air Lines Vibes</title>
	<!-- CSS only -->
...
<body style="padding-top: 92px;">
    ...
    <section class="pt-4 container-fluid pb-4">
                ...
                <tbody>
               	  <%for (int i=0; i<lista.size(); i++) { %>
               		<tr>
               			...
               			<td>
               			<a href="deletarUsuario?email=<%=lista.get(i).getEmail() %>"><button class="btn btn-warning">Excluir</button></a>
               			</td>
               		</tr>
               	  <%} %>
                </tbody>
